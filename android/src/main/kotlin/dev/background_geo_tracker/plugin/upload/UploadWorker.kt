package dev.background_geo_tracker.plugin.upload
...
import dev.background_geo_tracker.plugin.GeoConfigStore
import dev.background_geo_tracker.plugin.GeoEventBus
import dev.background_geo_tracker.plugin.GeoStatus
import dev.background_geo_tracker.plugin.db.GeoDatabase
import dev.background_geo_tracker.plugin.db.PointQueue
...
class UploadWorker(
    ...
    companion object {
        private const val PERIODIC = "background_geo_tracker_upload_periodic"
        private const val ONE_SHOT = "background_geo_tracker_upload_now"
