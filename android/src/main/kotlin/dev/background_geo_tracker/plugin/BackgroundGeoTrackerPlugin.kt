...
import dev.background_geo_tracker.plugin.log.GeoLogRow
import dev.background_geo_tracker.plugin.upload.UploadWorker

class BackgroundGeoTrackerPlugin :
    FlutterPlugin,
    ActivityAware,
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        methods = MethodChannel(binding.binaryMessenger, "background_geo_tracker/geo")
        methods.setMethodCallHandler(this)

        points = EventChannel(
            binding.binaryMessenger,
            "background_geo_tracker/geo/points",
        )
        ...
        statuses = EventChannel(
            binding.binaryMessenger,
            "background_geo_tracker/geo/status",
        )
